...
namespace SAT.UI.MVC.Controllers
{
    public class ScheduledClassesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["Scsid"] = new SelectList(_context.ScheduledClassStatuses, "Scsid", "Scsid");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ScheduledClassId,CourseId,StartDate,EndDate,InstructorName,Location,Scsid")] ScheduledClass scheduledClass)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.Courses, "CourseId", "CourseId", scheduledClass.CourseId);
            ViewData["Scsid"] = new SelectList(_context.ScheduledClassStatuses, "Scsid", "Scsid", scheduledClass.Scsid);
            return View(scheduledClass);
        }
